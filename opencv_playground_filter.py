...
def imgFiltering(url, maskUrl):
    ...
    cl1 = cv2.bilateralFilter(cl1, 7, 20, 40)
...
def detectEdgesAndDisplay(imgGray, imgMask, cl1):
    ...
    cl1Edges = cv2.Canny(image=cl1, threshold1=40, threshold2=50)
...
if __name__ == '__main__':
    imgFiltering("/Users/mschumacher/Documents/Scripts/smarte_geisternetze/ecker_snippets/2019apr04_ecker_sued_10002_5400_bot.png", 
                 "/Users/mschumacher/Documents/Scripts/smarte_geisternetze/ecker_snippets/2019apr04_ecker_sued_10002_5400_bot_mask.png")
